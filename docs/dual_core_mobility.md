...
**fable**　まさに。複雑に作り込んだものは、それ以上いじりにくい。単純な骨格は、拡張の余地を残している。日産が捨てた潔さは、未来への余白でもあった。この余白が、レンジエクステンダーへと育っていく土壌になります。

**soy**　ただ、世の中の見方は、まだそこまで追いついていない気がするんです。シリーズ式って、ハイブリッドの中では少数派でしょう。トヨタもホンダもスバルも、主流はシリーズパラレル。シリーズを選んでいるのは、日産のほかはダイハツくらい。しかもこれまでコンパクトカー中心に載ってきたから、なんとなく「廉価版ハイブリッド」と受け止められることも少なくない。

**fable**　その印象は、少し短絡的な見方だと思います。世の中の大抵の技術には一長一短があって、それぞれ得意とする局面が違う。適材適所の技術です。そして、シリーズ方式には、シリーズ方式にしかない構造上の切り札が、実はもう一つある。機械パスを捨てて、駆動を完全にモーターに委ねたということは——駆動系だけを見れば、**この車はもうEVと同じ骨格をしている**、ということなんです。

**soy**　エンジンは付いているけれど、骨格はEV。

**fable**　ええ。この「EVと骨格を共有している」という一点が、単なる乗り味の話を超えて、開発と収益の構造にまで効いてくる。捨てる思想の、いちばん深いところにある果実です。ここは第七章で、実際のユニット構成の数字とあわせて、じっくり見ていきましょう。
...
**soy**　ここで、第二章の伏線を回収したいんです。シリーズ式の切り札——「駆動系だけ見れば、この車はもうEVと同じ骨格をしている」という話。5-in-1の中身を見ると、それが具体的にわかる。

**fable**　ええ、ここが第三世代のいちばん面白いところです。日産は、EV用のパワートレインを「3-in-1」として開発しています。モーター、インバーター、減速機の三点一体。新型リーフが積んでいるのが、この第三世代の3-in-1で、ユニット容積を従来比で十パーセント削減しながら、最大トルクを四パーセント向上させている。そして、e-POWER用の5-in-1は、**この3-in-1に、発電機と増速機を加えたもの**なんです。

**soy**　まったく別のユニットを二つ作っているんじゃなくて、同じ土台に二部品を足しているだけ。

**fable**　そうです。両者は別物ではなく、基本構造を共有する**双子**です。自動車経済評論家の池田直渡さんが「宇宙が崩壊してもEVを進化させる仕組み」という思い切った見出しでこの構造を論じていましたが、大げさに聞こえて、指している中身は正確です。キックスの駆動モーターがリーフと同じYM52だった、という先ほどの話は、この双子構造の、型式番号レベルの現れなんです。

**soy**　これが、なぜ「宇宙が崩壊しても」なんですか。

**fable**　いま世界中のメーカーが抱えているジレンマから説明しましょう。EV市場は、期待されたほどには拡大しなかった。各社とも巨額のEV投資の回収に苦しんでいて、開発のペースダウンを余儀なくされている。でも、完全に止めるわけにはいかない。数年後に市場が再び動き始めたとき、このタイミングで開発を止めたメーカーは確実に出遅れるからです。**儲からないのに、開発を続けなければならない**。多くのメーカーにとって、EV開発費はEVで回収するしかないから、市場が停滞すれば、この痩せ我慢がそのまま財務を蝕む。

**soy**　日産は、そこが違う、と。

**fable**　双子構造だから、違うんです。e-POWERは、いま現に世界で台数を積み、利益を生んでいる。エルグランドも、キックスも、これから北米のローグも、全部この5-in-1で走る。その**儲かっているe-POWERを改良するためにモーターやインバーターを開発すれば、成果はそのまま3-in-1——つまりEV——に反映される**。逆にEV側で得た知見も、e-POWERに還元される。日産は「利益を生むe-POWERを育てることが、そのままEVを育てることになる」という構造を作り上げた。

**soy**　EV市場の読みが当たっても外れても、開発は止まらない。

**fable**　そこが核心です。市場の成長が予想より早まれば、鍛え続けた3-in-1でそのまま応じられる。遅れても、e-POWERという収益事業が技術開発を支え続けるから、痩せ我慢がいらない。**将来の市場予測が外れても開発を継続できる、レジリエントな開発システム**なんです。これは単なる部品共用ではありません。シリーズパラレル方式でも部品単位でEVと共用する例はありますが、双子とまで言える形になっているのは、機械パスを完全に捨てたシリーズ式だからこそ。第二章の「捨てる思想」の果実が、乗り味でも効率でもなく、**開発スキームの持続性**という、いちばん意外な場所で実っている。

**soy**　商品開発の人間として付け加えると、このスキームの利益は開発費だけじゃないんです。製造原価にも効く。

**fable**　ええ。モーターやインバーターという主要部品を3-in-1と5-in-1で共用すれば、生産量をまとめられて、スケールメリットが出る。日産は二〇一九年比で電動パワートレインのコストを約三十パーセント削減しており、将来的には内燃機関車に匹敵するコスト競争力を目指すとしている。先ほど触れたX-in-1構想——二〇二六年までにe-POWERをエンジン車と同等コストに——は、この延長線上にあります。電動化というと高性能化ばかりに目が向きがちですが、「より良いものを、より安く作る」ことも同じくらい重要で、EVが今ひとつブレークしない理由のひとつが価格の高さである以上、電池価格の低下をただ待つのではなく、それ以外の部分で地道にコストを削り続けるのもメーカーの仕事です。そう考えると、3-in-1と5-in-1は単なる技術ではなく、**開発・生産・収益構造まで一体で設計されたシステム**と言った方が実態に近い。

**soy**　私たちの構想にとっても、これは追い風ですよね。ジューク級レンジエクステンダーは、この双子の骨格の上に乗る話ですから。

**fable**　その通りです。純e-POWERの5-in-1に電池を足して外部充電口を付ける、という私たちの構想は、双子構造の「あいだ」に一席を作る話です。3-in-1のEVと、5-in-1のe-POWERが両端にあって、その部品はすべて共通で量産されている。だから、あいだのレンジエクステンダーに専用部品はほとんど要らない。開発スキームの側から見ても、私たちの構想は、すでに回っている歯車に一枚足すだけの提案なんです。
...
**fable**　トヨタの遊星機構は、機械パスを捨てない両取りの思想。複雑さを引き受けて、高速の効率を取りにいった。ハイブリッドとして真っ当に優れている。これはハイブリッドという枠の中での、一つの到達点です。一方、日産のe-POWERは、機械パスを捨てる割り切りの思想。単純さと一貫したEV体験を取り、その単純な骨格は、電池を足すだけでレンジエクステンダーへと育つ発展性を秘めていた。しかもその骨格はEV用3-in-1と部品を分け合う双子で、稼ぐe-POWERがEVの開発を支え続けるという、市場予測が外れても壊れない開発スキームまで生んでいる。どちらが負けという話ではありません。トヨタはロスの最小化に価値を置き、日産は単純さと発展性に価値を置いた。評価軸が違うものを、優劣ではなく哲学の差として並べる。それが、技術に対する誠実な態度です。
...
**soy**　その「橋渡し」という言葉、第七章の双子構造を踏まえると、読み方が一段深くなりますよね。

**fable**　ええ。「橋渡し」は普通、商品の話として読まれます。お客さんがe-POWERでEVの乗り味に慣れて、いつかBEVに乗り換える、という需要側の橋。でも3-in-1と5-in-1の双子構造まで見ると、この橋は**開発費が渡る橋**でもある。e-POWERが世界で稼いだ利益が、共通部品の改良という形でEVの進化に注ぎ込まれ続ける。EV市場がいつ立ち上がるか——その予測が外れても、橋の通行は止まらない。需要の橋であると同時に、資金と技術の橋。日産の公式の地図に書かれた一語の裏に、それだけの構造が畳み込まれているわけです。
...
本書は一連の対話を新書体裁に再構成した私的検討記録の改訂版である。第三世代e-POWERの発電特化型エンジンは二種類あり（日産公式技術情報）、上級のZR15DDTe（1.5L直3ターボ・STARC燃焼・熱効率42%、エルグランド／キャシュカイ搭載）と、HR14DDe（1.4L直3自然吸気・熱効率40%、新型キックス搭載）からなる。新型キックスの確定諸元（2026年6月発表・299万9700円〜・発電エンジンHR14DDe 1.433L 72kW・駆動モーターYM52 105kW/315N·m・タンク45L・WLTC最良25.7km/L／高速モード23.8km/L・車両重量1430kg〜）、第三世代の5-in-1電動ユニット・高速燃費+14%・純e-POWER電池2.1kWh・2025年夏に欧州キャシュカイで量産開始、EV用3-in-1（モーター・インバーター・減速機）と5-in-1（同+発電機・増速機）の基本構造共有、新型リーフ第3世代3-in-1のユニット容積従来比10%削減・最大トルク4%向上、電動パワートレインコストの2019年比約30%削減と内燃機関車同等のコスト競争力目標、および東風日産NX8の諸元（2026年4月8日正式発売・天演アーキテクチャー2.0・全長4870×全幅1920×全高1680mm／WB2917mm・増程版はLFP電池20〜21kWh級または43.2kWh〔CATL／瑞浦蘭鈞〕・増程器1.5L直4ターボ NR15T 109kW・駆動モーター195kW/310N·m・CLTC EV走行150/310km・総合航続1320/1450km・亏電油耗4.51L/100km・指導価15.99〜20.99万元〔限時14.99〜19.99万元〕・全系6.6kW外部給電。純電版は215/250kW・73/81kWh・800V5C・CLTC580/650km）は公表情報・報道に基づく事実。日産は中国を低価格EVの輸出拠点と位置づけ、N7等のNシリーズを2026年から東南アジア・中東・中南米へ輸出する方針（日本経済新聞報道）。北米のローグHybrid e-POWER（2026年後半・2027年モデル）、エクステラ復活（キャントン生産・2028年後半・V6およびV6ハイブリッド）、中国Frontier Pro／Pro PHEV（鄭州日産・輸出向け）も日産公式発表に基づく。電池10〜20kWh化・外部充電化・総航続約1,000〜1,100km等の構成数値は試算であり、実車を保証するものではない。電費7km/kWh・発電18〜23km/Lは軽量ジューク級を前提とした想定値（看板値23km/Lは同車格キックスのWLTC高速モード23.8km/Lを根拠とし、実走想定値とは基準が異なる）。電気パス損失・充電出力・電池重量等の一般値は改訂時点の技術水準に基づく概数である。3-in-1／5-in-1を「双子」と捉える開発スキーム論は、池田直渡氏の連載「5分でわかるクルマ経済」の論考に示唆を得た。
