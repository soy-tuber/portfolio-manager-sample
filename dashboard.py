...
FY26Q1 = {'rev': 29642, 'op': 779, 'opm': 2.63, 'ord': 491, 'net': 38, 'eps': 1.08,
          'auto_op': -83, 'fin_op': 862, 'gpm': 15.84}
...
st.success(
    "**通期見通し (売上13.0兆 / 営業利益2,000億 / 純利益200億) は維持。** "
    "自動車事業の営業損益は**▲83億とほぼ損益均衡**（関税影響込み）。"
    "連結営業利益は前年同期比**+1,570億円の改善**。"
)
...
q4.metric("当期純利益", f"+{FY26Q1['net']}億", "前年▲1,158億 (黒字転換)")
...
q8.metric("為替", "160円/USD", "前年145円 / 前提150円", delta_color="off")
q9.metric("自動車ネットキャッシュ", "約9,700億", "1兆円規模を維持", delta_color="off")
...
st.info(
    ...
    "**中国:** 暦年上期販売は市場全体▲22%に対し▲15%。市場環境を反映し販売台数見通しは下方修正。"
)
